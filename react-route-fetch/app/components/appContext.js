...
function hydrate(props) {
  if(typeof APP_PROPS !== 'undefined') {
    return {
      ...
      componentsArray: props.components.filter(component => component && component.loadProps)
    }
  }else {
    return null;
  }
...
class PropsContainer extends Component {
  ...
  render() {
    ...
    return (
      <Component {...props} {...routerProps} {...asyncProps} />
    )
  }
}
export default class AppContext extends Component {
  ...
  constructor(props, context) {
    ...
    this.state = {
      didMount: false,
      propsAndComponents: isServerRender ? { propsArray, componentsArray } : hydrate(props)
    }
  }
  componentDidMount() {
